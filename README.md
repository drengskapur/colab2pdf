...
def colab2pdf():
    ...
    def convert(b):
        try:
            ...
            nb = nbformat.v4.new_notebook(cells=nb or [nbformat.v4.new_code_cell('#')]); nbformat.validate(nb)
            with (p / f'{n.stem}.ipynb').open('w', encoding='utf-8') as cp: nbformat.write(nb, cp)
